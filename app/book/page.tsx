...
export default function Book() {
  ...
  const onSubmit = async (values: BookingData /*z.infer<typeof formSchema>*/) => {
    ...
    <>
      ...
      <Navbar />
        ...
        <div className="mx-auto my-0 px-[5vw] py-[5vh] sm:max-w-3xl flex flex-col">
          {step === 0 && <BookForm pickup={pickup} date={date} onSubmit={onSubmit} handleBack={handleBack} form={form}/>}
          {step === 1 && <div className="px-auto py-0 w-full">
                            <BusLayout price={price} handleBack={handleBack} data={data} onSubmit={onSubmit}/>
                         </div>
          }
          {step === 2 && <div className="px-auto py-0 w-full">
                            <PayDialog paymentForm={paymentForm} onSubmit={onSubmit} data={data} price={price} handleBack={handleBack}/>
                         </div>
          }
        </div>
